...
platform6.body.checkCollision.down = false;
    ...
    player.setSize(40, 95); // Adjust the width and height as needed
    player.setBounce(0);
...
this.physics.add.overlap(player, [redbouncyenemy1, redbouncyenemy2, redbouncyenemy3, redbouncyenemy4, redbouncyenemy5], function (player, enemy) {
    ...
    // Create player animations
       this.anims.create({
           key: 'left',
           frames: this.anims.generateFrameNumbers('dude', { start: 0, end: 21 }),  // Adjust end frame based on the number of frames in your sprite
           frameRate: 25,
           repeat: -1
       });
       ...
       this.anims.create({
           key: 'right',
           frames: this.anims.generateFrameNumbers('dude', { start: 0, end: 21 }),  // Adjust start and end frames based on the number of frames in your sprite
           frameRate: 25,
           repeat: -1
       });
